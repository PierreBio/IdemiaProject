...
cfg = dict(
    _base_=dict(
        ...
        default_hooks=dict(
            ...
            checkpoint=dict(
                _scope_='mmpose', interval=10, type='CheckpointHook'),
    ...
    default_hooks=dict(
        checkpoint=dict(max_keep_ckpts=1, rule='greater',
                        save_best='coco/AP')),
    input_size=(
        192,
        256,
    ...
    load_from=
    'checkpoints/rtmpose-tiny_simcc-aic-coco_pt-aic-coco_420e-256x192-cfc8f33d_20230126.pth',
    max_epochs=420,
    model=dict(
        backbone=dict(
            _scope_='mmdet',
    ...
    test_dataloader=dict(
        ...
        dataset=dict(
            ...
            pipeline=[
                ...
                dict(patch_size=100, type='Occlude'),
                dict(type='PackPoseInputs'),
            ],
            test_mode=True,
            type='CocoDataset'),
    ...
    test_evaluator=dict(
        ...
        format_only=False,
        outfile_prefix='output/rtmpose-t-wOcclusion',
        type='CocoMetric'),
...
load_from = 'checkpoints/rtmpose-tiny_simcc-aic-coco_pt-aic-coco_420e-256x192-cfc8f33d_20230126.pth'
log_level = 'INFO'
log_processor = dict(
    _scope_='mmpose',
    by_epoch=True,
